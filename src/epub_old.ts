...
/**
 *  new Epub_old(fname[, imageroot][, linkroot])
 ...
 *
 *      var epub = new Epub_old("book.epub");
 ...
 **/
class Epub_old extends EventEmitter {
  ...
  /**
   *  Epub_old#parse(options) -> undefined
  ...
  /**
   *  Epub_old#checkMimeType() -> undefined
   *
  ...
  /**
   *  Epub_old#getRootFiles() -> undefined
   *
  ...
  /**
   *  Epub_old#handleRootFile() -> undefined
   *
  ...
  /**
   *  Epub_old#parseRootFile() -> undefined
   *
  ...
  /**
   *  Epub_old#parseMetadata() -> undefined
   *
  ...
  /**
   *  Epub_old#parseManifest() -> undefined
   *
  ...
  /**
   *  Epub_old#walkNavMap(branch, path, id_list,[, level]) -> Array
  ...
  /**
   *  Epub_old#getChapter(id, callback) -> undefined
  ...
  /**
   *  Epub_old#getChapterRaw(id, callback) -> undefined
   *  - id (String): Manifest id value for a chapter
   *  - callback (Function): callback function
   *
  ...
  /**
   *  Epub_old#getImage(id, callback) -> undefined
  ...
  /**
   *  Epub_old#getFile(id, callback) -> undefined
